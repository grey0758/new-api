...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		{
			userRoute.POST("/register/challenge", middleware.RegistrationChallengeRateLimit(), controller.CreateRegistrationChallenge)
			...
			userRoute.POST("/wxda-epay/notify", controller.WxDaEpayNotify)
			userRoute.GET("/wxda-epay/notify", controller.WxDaEpayNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/wxda-epay/pay", middleware.CriticalRateLimit(), controller.RequestWxDaEpay)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/token/resolve", controller.AdminResolveToken)
				adminRoute.GET("/:id/oauth/bindings", controller.GetUserOAuthBindingsByAdmin)
				adminRoute.DELETE("/:id/oauth/bindings/:provider_id", controller.UnbindCustomOAuthByAdmin)
				adminRoute.DELETE("/:id/bindings/:binding_type", controller.AdminClearUserBinding)
				adminRoute.POST("/:id/quota/increase", controller.AdminIncreaseUserQuota)
				adminRoute.POST("/:id/tokens", controller.AdminCreateTokenForUser)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.PATCH("/users/:id/subscriptions/:subscription_id/end_time", controller.AdminUpdateUserSubscriptionEndTime)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/health/:id/events", controller.GetChannelHealthEvents)
			channelRoute.POST("/health/:id/cooldown/recover", controller.RecoverChannelHealthCooldown)
